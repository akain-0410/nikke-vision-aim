...
def set_native_window_geometry(window: QWidget, geometry: WindowGeometry) -> None:
    """Place a Qt window using the same physical pixels returned by Win32 capture."""
...
def set_native_window_position(window: QWidget, left: int, top: int) -> None:
    win32gui.SetWindowPos(
        int(window.winId()),
        win32con.HWND_TOPMOST,
        left,
